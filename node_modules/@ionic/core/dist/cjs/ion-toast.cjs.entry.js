...
var overlays = require('./overlays--dagG4QM.js');
...
function warnIfAnchorIsHidden(positionAnchor, toast) {
    if (positionAnchor.offsetParent === null) {
        index$1.printIonWarning('[ion-toast] - The positionAnchor element for ion-toast was found in the DOM, but appears to be hidden. This may lead to unexpected positioning of the toast.', toast);
    }
}
/**
...
const Toast = class {
    constructor(hostRef) {
        ...
        this.didPresent = index$1.createEvent(this, "ionToastDidPresent", 7);
        this.willPresent = index$1.createEvent(this, "ionToastWillPresent", 7);
        this.willDismiss = index$1.createEvent(this, "ionToastWillDismiss", 7);
        this.didDismiss = index$1.createEvent(this, "ionToastDidDismiss", 7);
         ...
         */
        this.duration = index$1.config.getNumber('toastDuration', 0);
        /**
    ...
    getAnchorElement() {
        ...
        if (position === 'middle' && positionAnchor !== undefined) {
            index$1.printIonWarning('[ion-toast] - The positionAnchor property is ignored when using position="middle".', this.el);
            return undefined;
        }
        if (typeof positionAnchor === 'string') {
            ...
            if (foundEl === null) {
                index$1.printIonWarning(`[ion-toast] - An anchor element with an ID of "${positionAnchor}" was not found in the DOM.`, el);
                return undefined;
            }
            return foundEl;
        }
        ...
        index$1.printIonWarning('[ion-toast] - Invalid positionAnchor value:', positionAnchor, el);
        return undefined;
    }
    ...
    async callButtonHandler(button) {
        if (button === null || button === void 0 ? void 0 : button.handler) {
            ...
            try {
                ...
                index$1.printIonError('[ion-toast] - Exception in callButtonHandler:', e);
            }
        }
        return true;
    }
    renderButtons(buttons, side) {
        ...
        return (index$1.h("div", { class: buttonGroupsClasses }, buttons.map((b) => (index$1.h("button", Object.assign({}, b.htmlAttributes, { type: "button", class: buttonClass(b), tabIndex: 0, onClick: () => this.buttonClick(b), part: buttonPart(b) }), index$1.h("div", { class: "toast-button-inner" }, b.icon && (index$1.h("ion-icon", { "aria-hidden": "true", icon: b.icon, slot: b.text === undefined ? 'icon-only' : undefined, class: "toast-button-icon" })), b.text), mode === 'md' && (index$1.h("ion-ripple-effect", { type: b.icon !== undefined && b.text === undefined ? 'unbounded' : 'bounded' })))))));
    }
    /**
    ...
    renderToastMessage(key, ariaHidden = null) {
        ...
        if (customHTMLEnabled) {
            return (index$1.h("div", { key: key, "aria-hidden": ariaHidden, class: "toast-message", part: "message", innerHTML: config.sanitizeDOMString(message) }));
        }
        return (index$1.h("div", { key: key, "aria-hidden": ariaHidden, class: "toast-message", part: "message" }, message));
    }
    /**
    ...
    renderHeader(key, ariaHidden = null) {
        return (index$1.h("div", { key: key, class: "toast-header", "aria-hidden": ariaHidden, part: "header" }, this.header));
    }
    render() {
